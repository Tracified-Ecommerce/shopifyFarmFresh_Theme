...
$(document).ready( function() {
      $(function() {
        ...
        var towns = {       
          '10120' : ['Battaramulla ', [3,2]],
          '4252' : ['Boralasgamuwa ', [5,5]],
          '00300' : ['Colombo 03 ', [1,3]],
          '00800' : ['Colombo 08 ', [6,5]],
          '00200' : ['Colombo 2 ', [2,3]],
          '00400' : ['Colombo 4 Bambalapitiya ', [3,6]],
          '00500' : ['Colombo 5 ', [6,1]],
          '00700' : ['Colombo 7 ', [5,4]],
          '10350' : ['Dehiwala ', [1,0]],
          '101002' : ['Ethul Kotte ', [5,4]],
          '4251' : ['Hokandara ', [2,2]],
          '4256' : ['Kadawatha ', [4,5]],
          '4250' : ['Kaduwela ', [4,0]],
          '4255' : ['Keleniya ', [6,4]],
          '4256' : ['Kiribathgoda ', [5,0]],
          '4249' : ['Koswatta Battaramulla ', [4,6]],
          '101001' : ['Kotte ', [2,6]],
          '10115' : ['Malabe ', [4,1]],
          '4250' : ['Moratuwa ', [2,6]],
          '10370' : ['Mt laviniya ', [0,1]],
          '11222' : ['Nawala ', [5,6]],
          '10250' : ['Nugegoda ', [5,4]],
          '10230' : ['Pannipitiya ', [5,6]],
          '4853' : ['Papiliyana Nugegoda ', [4,6]],
          '12138' : ['Pelawatta ', [4,2]],
          '10100' : ['Rajagiriya ', [1,0]],
          '4252' : ['Rathmalana ', [2,6]],
          '00701' : ['Retail Shop Colombo 07 ', [0,4]],
          '4248' : ['Saturday Good Market Race Course Colombo ', [2,6]],
          '4236' : ['Thalawathugoda ', [0,6]],
          '4254' : ['Wattala ', [1,1]],
          '00600' : ['Wellawatta Colombo 06 ', [2,4]]
        }
        ...
        var select_ele = document.getElementById('select_town');
        
        for (var key in towns) {
          console.log("key " + key + " has value " + towns[key]);
          var opt = document.createElement('option');
            opt.value = key;
            opt.innerHTML = towns[key][0];
...
//         } );
        ...
        var tuesday = nextDay(2);
        console.log(tuesday);
        $('#date1').text("Next Tuesday (" + tuesday + ")");
        
        var thursday = nextDay(4);
        console.log(thursday);
        $('#date2').text("Next Thursday (" + thursday + ")");
        ...
        $( 'select[id=select_town]' ).change(function() {
          ...
          for(var i=0, len=towns[town][1].length; i < len; i++){
            
            var day = days[towns[town][1][i]];
            var date = nextDay(towns[town][1][i]);
            console.log(day);
            console.log(date);
            var bttn = '<input type="radio" name="attributes[Delivery-On]">'
            var radioBtn = $(bttn);
            var span = $('<span> Next '+ day + '('+ date +')' +' </span><br>');
            radioBtn.val(date);
            radioBtn.appendTo('#delivery_on');
            span.appendTo('#delivery_on');
          }          
          ...
          $.ajax({
					type: 'PUT',
	                url: 'https://99xnsbm.myshopify.com/admin/orders/6001570452.json',
	                data: {
                            "order": {
                              "id": 6002061524,
                    ...
                    beforeSend: function(xhr) {
                      xhr.setRequestHeader('Authorization', 'Basic ' + window.btoa(unescape(encodeURIComponent('2442afcf38da0e7ffb1e514b6887b8ec:a1346641fc6eb0fb97243623a95ee870'))))
                    },
